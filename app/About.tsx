  ...
  return (
    <>
      <div className="text-white flex flex-col items-center">
        <h4 className="text-4xl md:text-6xl text-transparent bg-custom-gradient bg-clip-text my-4 lg:mb-8">
          About
        </h4>
        <p className="text-base md:text-3xl text-justify w-3/4 lg:w-3/5 mt-4 lg:mt-8 mb-4 lg:mb-16">
      ...
      <div className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-4 p-4 md:w-3/4 md:mx-auto">
